...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        #print("test 3:", type(self.pretrained_embeddings), self.pretrained_embeddings)
    ...
    def forward(self, t):
        ...
        hidden_layer = self.embed_to_hidden(x)
        relu = nn.ReLU()
        hidden_layer_unit = relu(hidden_layer)
        dropout_layer = self.dropout(hidden_layer_unit)
